...
from config import MODEL_NAME, OUTPUT_DIR_S, SSFT_MODEL_PATH, BATCH_SIZE, EPOCHS, LR, MAX_LENGTH
...
def main():
    ...
    print("Saving model...")
    trainer.save_model(SSFT_MODEL_PATH)
    tokenizer.save_pretrained(SSFT_MODEL_PATH)
